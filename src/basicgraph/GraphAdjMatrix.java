...
public class GraphAdjMatrix extends Graph {
	...
	public List<Integer> getDistance2(int v) {
		int rowNum = adjMatrix.length;
		int[][] tempMatrix = new int[rowNum][rowNum];
		//Use matrix multiplication to get an adjMatrix of second degree 
		...
		//Copy the getNeighbors function from above
		List<Integer> neighbors = new ArrayList<Integer>();
		for (int i = 0; i < rowNum; i ++) {
			for (int j=0; j< tempMatrix[v][i]; j ++) {
				neighbors.add(i);
			}
		}
		return neighbors;
